...
public class BinningMaskingProviderConfig extends MaskingProviderConfig {
  ...
  public void setSingleBucketUnderThresholdReplacement(
      String singleBucketUnderThresholdReplacement) {
  ...
  public int hashCode() {
    ...
    result = prime * result + Objects.hash(binSize, format, singleBucketOverThresholdReplacement,
        singleBucketOverThresholdValue, singleBucketUnderThresholdReplacement,
        singleBucketUnderThresholdValue, startValue, useSingleBucketOverThreshold,
        useSingleBucketUnderThreshold, useStartValue);
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return binSize == other.binSize && Objects.equals(format, other.format)
        && Objects.equals(singleBucketOverThresholdReplacement,
            other.singleBucketOverThresholdReplacement)
        && Double.doubleToLongBits(singleBucketOverThresholdValue) == Double
            .doubleToLongBits(other.singleBucketOverThresholdValue)
        && Objects.equals(singleBucketUnderThresholdReplacement,
            other.singleBucketUnderThresholdReplacement)
        ...
        && useSingleBucketOverThreshold == other.useSingleBucketOverThreshold
