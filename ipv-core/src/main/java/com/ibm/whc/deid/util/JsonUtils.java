...
import com.ibm.whc.deid.util.exceptions.MisconfigurationException;
...
public class JsonUtils {
  ...
  public static void validateField(JsonNode configuration, String key, JsonNodeType expectedType)
    ...
    if (node == null) {
      ...
      throw new MisconfigurationException(
          "Key " + key + " has wrong type. Expected is: " + expectedType.toString());
    }
  }
