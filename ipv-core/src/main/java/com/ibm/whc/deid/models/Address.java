...
public class Address {
   ...
   */
  public Address(String number, String name, String roadType, String cityOrState, String country,
      String postalCode) {
    this.number = number;
    this.name = name;
  ...
  public String toString() {
    ...
    // return String.format("%s %s %s, %s %s, %s", number, name, roadType,
    // cityOrState, postalCode, country);
  }
}
