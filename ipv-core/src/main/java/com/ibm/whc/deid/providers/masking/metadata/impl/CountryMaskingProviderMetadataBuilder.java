...
/**
 * Obtains metadata for the COUNTRY masking provider.
 */
public class CountryMaskingProviderMetadataBuilder extends MaskingProviderMetadataBuilderBase {
  ...
  protected List<ConfigurationOptionModel> getOptions(MaskingProviderTypes provider, Locale locale) {
    ...
    options.add(
        buildOption(provider.getIdentifier(), "maskClosestK", bundle, OptionType.Integer, "10"));
    return options;
  }
}
