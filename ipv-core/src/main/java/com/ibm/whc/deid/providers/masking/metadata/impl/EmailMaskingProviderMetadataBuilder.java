...
/**
 * Obtains metadata for the EMAIL masking provider.
 */
public class EmailMaskingProviderMetadataBuilder extends MaskingProviderMetadataBuilderBase {
  ...
  protected List<ConfigurationOptionModel> getOptions(MaskingProviderTypes provider, Locale locale) {
    ...
    options
        .add(buildOption(provider.getIdentifier(), "nameLength", bundle, OptionType.Integer, "-1"));
    return options;
  }
