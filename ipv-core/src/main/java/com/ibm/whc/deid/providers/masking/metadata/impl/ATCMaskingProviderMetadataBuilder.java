...
/**
 * Obtains metadata for the ATC masking provider.
 */
public class ATCMaskingProviderMetadataBuilder extends MaskingProviderMetadataBuilderBase {
  ...
  protected List<ConfigurationOptionModel> getOptions(MaskingProviderTypes provider, Locale locale) {
    ...
    options.add(
        buildOption(provider.getIdentifier(), "maskLevelsToKeep", bundle, OptionType.Integer, "4"));
    return options;
  }
}
