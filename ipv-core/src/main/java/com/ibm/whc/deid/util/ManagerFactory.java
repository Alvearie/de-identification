...
public class ManagerFactory {
  ...
  ConcurrentHashMap<Resource, Manager> managers = new ConcurrentHashMap<>();
  ...
  public static ManagerFactory getInstance() {
	 ...
	 * @return
	 */
	public Manager getManager(String tenantId, Resource resourceType, Object options) {
