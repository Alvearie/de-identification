...
/**
 * Obtains metadata for the IMEI masking provider.
 */
public class IMEIMaskingProviderMetadataBuilder extends MaskingProviderMetadataBuilderBase {
  ...
  protected List<ConfigurationOptionModel> getOptions(MaskingProviderTypes provider, Locale locale) {
    ...
    options.add(buildOption(provider.getIdentifier(), "preserveTAC", bundle, OptionType.Boolean,
