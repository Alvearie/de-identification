...
/**
 * Obtains metadata for the MAC_ADDRESS masking provider.
 */
public class MACAddressMaskingProviderMetadataBuilder extends MaskingProviderMetadataBuilderBase {
  ...
  protected List<ConfigurationOptionModel> getOptions(MaskingProviderTypes provider, Locale locale) {
    ...
    options.add(buildOption(provider.getIdentifier(), "maskingPreserveVendor", bundle,
