...
public class ResourceDescriptionFactory {
   ...
   */
  public static ResourceDescription getDescription(Resources resource) {
    if (resource instanceof Resource) {
      switch ((Resource) resource) {
        ...
        case ICDV9:
          return new ResourceDescription(resource, ResourceFormat.CSV,
              Arrays.asList("delimiter: ';'", "quote: '\"'"), "ICD v9",
              Arrays.asList("disease code", "name", "name", "category code", "category name",
                  "chapter code", "chapter name"));
        case ICDV10:
          return new ResourceDescription(resource, ResourceFormat.CSV,
              Arrays.asList("delimiter: ','", "quote: '\"'"), "ICD v10",
              Arrays.asList("disease code", "name", "category code", "category name",
                  "chapter code", "chapter name"));
